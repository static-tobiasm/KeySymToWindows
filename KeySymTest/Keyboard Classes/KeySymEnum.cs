/* 
 * 
 * File was hand-crafted by Tobias Müller, tobias.mueller@progile.ch, as he couldn't find a complete KeySym enum anywhere
 * 
 */
...
namespace Progile.KeysymHelper
{
    public enum KeySym : uint
    {
         ...
         , Super_L = 0xffeb      // Left super, Windows Flag
         ...
         , Parenthesis_left = 0x0028      // U+0028 LEFT PARENTHESIS
         , Parenthesis_right = 0x0029      // U+0029 RIGHT PARENTHESIS
         ...
         , Decimal0 = 0x0030      // U+0030 DIGIT ZERO
         , Decimal1 = 0x0031      // U+0031 DIGIT ONE
         , Decimal2 = 0x0032      // U+0032 DIGIT TWO
         , Decimal3 = 0x0033      // U+0033 DIGIT THREE
         , Decimal4 = 0x0034      // U+0034 DIGIT FOUR
         , Decimal5 = 0x0035      // U+0035 DIGIT FIVE
         , Decimal6 = 0x0036      // U+0036 DIGIT SIX
         , Decimal7 = 0x0037      // U+0037 DIGIT SEVEN
         , Decimal8 = 0x0038      // U+0038 DIGIT EIGHT
         , Decimal9 = 0x0039      // U+0039 DIGIT NINE
         , Colon = 0x003a      // U+003A COLON
         , Semicolon = 0x003b      // U+003B SEMICOLON
         , LessThan = 0x003c      // U+003C LESS-THAN SIGN
         , Equal = 0x003d      // U+003D EQUALS SIGN
         , GreaterThan = 0x003e      // U+003E GREATER-THAN SIGN
         ...
         , Bracket_Left = 0x005b      // U+005B LEFT SQUARE BRACKET
         , Backslash = 0x005c      // U+005C REVERSE SOLIDUS
         , Bracket_Right = 0x005d      // U+005D RIGHT SQUARE BRACKET
         , AccentCircumflex = 0x005e      // U+005E CIRCUMFLEX ACCENT
         , Underscore = 0x005f      // U+005F LOW LINE
         , AccentGrave = 0x0060      // U+0060 GRAVE ACCENT
         ...
         , Curlybracket_Left = 0x007b      // U+007B LEFT CURLY BRACKET
         , Bar = 0x007c      // U+007C VERTICAL LINE
         , Curlybracket_Right = 0x007d      // U+007D RIGHT CURLY BRACKET
         , Tilde = 0x007e      // U+007E TILDE
         , Nobreakspace = 0x00a0      // U+00A0 NO-BREAK SPACE
         , ExclamationInverted = 0x00a1      // U+00A1 INVERTED EXCLAMATION MARK
         ...
         , AccentAcute = 0x00b4      // U+00B4 ACUTE ACCENT
         , Mu = 0x00b5      // U+00B5 MICRO SIGN
         , Paragraph = 0x00b6      // U+00B6 PILCROW SIGN
         , MiddleDot = 0x00b7      // U+00B7 MIDDLE DOT
         ...
         , QuestionInverted = 0x00bf      // U+00BF INVERTED QUESTION MARK
         ...
         , Oslash, Ooblique = 0x00d8      // U+00D8 LATIN CAPITAL LETTER O WITH STROKE
         ...
         , oslash, ooblique = 0x00f8      // U+00F8 LATIN SMALL LETTER O WITH STROKE
         ...
         , Farsi_yeh, Arabic_farsi_yeh = 0x10006cc      // U+06CC ARABIC LETTER FARSI YEH
         ...
         , Greek_LAMDA, Greek_LAMBDA = 0x07cb      // U+039B GREEK CAPITAL LETTER LAMDA
         ...
         , Greek_lamda, Greek_lambda = 0x07eb      // U+03BB GREEK SMALL LETTER LAMDA
